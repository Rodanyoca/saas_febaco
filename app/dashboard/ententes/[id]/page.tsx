...
export default function EntenteDetailPage(){
  ...
  return <div className="flex flex-col"><Header title={`Fiche Entente : ${entente.nom}`} subtitle={display(entente.ligue)}/><main className="flex-1 space-y-6 p-4 md:p-6">
    ...
    <div className="grid gap-6 lg:grid-cols-2">
      <DetailCard title="Informations générales" icon={Network} fields={[{label:"ID Entente",value:entente.id},{label:"Nom de l’entente",value:entente.nom},{label:"Sigle",value:display(entente.sigle||entente.pseudo)},{label:"Ligue",value:display(entente.ligue)},{label:"Ville",value:display(entente.ville)},{label:"Statut",value:display(entente.statut)}]}/>
